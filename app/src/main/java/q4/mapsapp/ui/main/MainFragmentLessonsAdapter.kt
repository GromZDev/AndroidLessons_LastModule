...
class MainFragmentLessonsAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder {
        ...
        return when (viewType) {
            TYPE_ONE -> MainLessonsViewHolder(
                inflater.inflate(R.layout.item_lessons_main_fragment_rv, parent, false) as View
            )
            else -> MainLessonsNoVideoViewHolder(
                inflater.inflate(
                    R.layout.item_lessons_main_fragment_no_video_rv, parent,
                    false
                ) as View
            )
